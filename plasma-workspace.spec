...
Source0  : https://download.kde.org/stable/plasma/5.23.4/plasma-workspace-5.23.4.tar.xz
Source1  : kde.pam
Source2  : kde-np.pam
...
%prep
%setup -q -n plasma-workspace-5.23.4
cd %{_builddir}/plasma-workspace-5.23.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638363653
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/BSD-2-Clause.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/52039e5c19c950d4c7d6ec5da42ebba2c6def7ee
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LicenseRef-KDE-Accepted-GPL.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/7d9831e05094ce723947d729c2a46a09d6e90275
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-workspace-5.23.4/LICENSES/MIT.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/81e12d0c07782abcf558af7aa19846e3e2606a70
cp %{_builddir}/plasma-workspace-5.23.4/kcms/kfontinst/viewpart/COPYING.UNICODE %{buildroot}/usr/share/package-licenses/plasma-workspace/ae855f68ab20f57b2cc7e9b03f54a87563424eb9
cp %{_builddir}/plasma-workspace-5.23.4/ksmserver/Copyright.txt %{buildroot}/usr/share/package-licenses/plasma-workspace/d53ea4b152ed3d9d8a96650bd70f5fbb9e9a3ef9
cp %{_builddir}/plasma-workspace-5.23.4/ksmserver/LICENSE %{buildroot}/usr/share/package-licenses/plasma-workspace/67218f86a21c5afe177def300337c7ff8ccf40f9
cp %{_builddir}/plasma-workspace-5.23.4/runners/bookmarks/autotests/firefox/firefox-config-home/atnsd8ae.testmekde/favicons.sqlite.license %{buildroot}/usr/share/package-licenses/plasma-workspace/a028dffb75c61fce4214fd36610c85eabfc43a3f
cp %{_builddir}/plasma-workspace-5.23.4/runners/bookmarks/autotests/firefox/firefox-config-home/atnsd8ae.testmekde/places.sqlite.license %{buildroot}/usr/share/package-licenses/plasma-workspace/a028dffb75c61fce4214fd36610c85eabfc43a3f
pushd clr-build
%make_install
popd
...
/usr/lib64/libcolorcorrect.so.5.23.4
/usr/lib64/libkfontinst.so.5
/usr/lib64/libkfontinst.so.5.23.4
/usr/lib64/libkfontinstui.so.5
/usr/lib64/libkfontinstui.so.5.23.4
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.23.4
/usr/lib64/libnotificationmanager.so.1
/usr/lib64/libnotificationmanager.so.5.23.4
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.23.4
/usr/lib64/libtaskmanager.so.5.23.4
