...
Version  : 5.14.2
Release  : 17
URL      : https://github.com/KDE/plasma-workspace/archive/v5.14.2.tar.gz
Source0  : https://github.com/KDE/plasma-workspace/archive/v5.14.2.tar.gz
...
%prep
%setup -q -n plasma-workspace-5.14.2
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1540464833
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libcolorcorrect.so.5.14.2
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.14.2
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.14.2
/usr/lib64/libtaskmanager.so.5.14.2
