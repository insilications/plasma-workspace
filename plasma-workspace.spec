...
Version  : 5.13.3
Release  : 1
URL      : https://github.com/KDE/plasma-workspace/archive/v5.13.3.tar.gz
Source0  : https://github.com/KDE/plasma-workspace/archive/v5.13.3.tar.gz
...
%prep
%setup -q -n plasma-workspace-5.13.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1532468591
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
/usr/lib64/libcolorcorrect.so.5.13.3
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.13.3
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.13.3
/usr/lib64/libtaskmanager.so.5.13.3
