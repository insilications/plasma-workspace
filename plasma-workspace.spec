...
%prep
%setup -q -n plasma-workspace-5.16.0
%patch1 -p1
...
/usr/lib64/libcolorcorrect.so.5.16.0
...
/usr/lib64/libkworkspace5.so.5.16.0
/usr/lib64/libnotificationmanager.so.1
/usr/lib64/libnotificationmanager.so.5.16.0
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.16.0
/usr/lib64/libtaskmanager.so.5.16.0
