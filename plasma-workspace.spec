...
Source0  : https://github.com/KDE/plasma-workspace/archive/v5.14.0.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : BSD-3-Clause GFDL-1.2 GPL-2.0 LGPL-2.1 MIT
Requires: plasma-workspace-bin
Requires: plasma-workspace-lib
Requires: plasma-workspace-data
Requires: plasma-workspace-license
...
%prep
%setup -q -n plasma-workspace-5.14.0
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1539119043
mkdir -p clr-build
pushd clr-build
...
cp COPYING.DOC %{buildroot}/usr/share/doc/plasma-workspace/COPYING.DOC
cp COPYING.LIB %{buildroot}/usr/share/doc/plasma-workspace/COPYING.LIB
cp freespacenotifier/COPYING %{buildroot}/usr/share/doc/plasma-workspace/freespacenotifier_COPYING
cp ksmserver/Copyright.txt %{buildroot}/usr/share/doc/plasma-workspace/ksmserver_Copyright.txt
cp ksmserver/LICENSE %{buildroot}/usr/share/doc/plasma-workspace/ksmserver_LICENSE
pushd clr-build
%make_install
popd
...
/usr/share/doc/plasma-workspace/ksmserver_Copyright.txt

%files lib
%defattr(-,root,root,-)
/usr/lib64/libcolorcorrect.so.5
/usr/lib64/libcolorcorrect.so.5.14.0
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.14.0
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.14.0
/usr/lib64/libtaskmanager.so.5.14.0
...
%files license
%defattr(0644,root,root,0755)
/usr/share/doc/plasma-workspace/COPYING
/usr/share/doc/plasma-workspace/COPYING.DOC
/usr/share/doc/plasma-workspace/COPYING.LIB
/usr/share/doc/plasma-workspace/freespacenotifier_COPYING
/usr/share/doc/plasma-workspace/ksmserver_LICENSE
