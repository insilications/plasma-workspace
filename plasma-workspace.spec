...
%prep
%setup -q -n plasma-workspace-5.13.5
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1536124594
mkdir clr-build
pushd clr-build
...
/usr/lib64/libcolorcorrect.so.5.13.5
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.13.5
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.13.5
/usr/lib64/libtaskmanager.so.5.13.5
