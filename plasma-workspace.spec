...
Source0  : https://github.com/KDE/plasma-workspace/archive/v5.14.4.tar.gz
...
%prep
%setup -q -n plasma-workspace-5.14.4
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1543376540
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libcolorcorrect.so.5.14.4
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.14.4
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.14.4
/usr/lib64/libtaskmanager.so.5.14.4
