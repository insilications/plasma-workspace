...
Version  : 5.15.3
Release  : 28
URL      : https://github.com/KDE/plasma-workspace/archive/v5.15.3.tar.gz
Source0  : https://github.com/KDE/plasma-workspace/archive/v5.15.3.tar.gz
...
%prep
%setup -q -n plasma-workspace-5.15.3
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1552405595
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libcolorcorrect.so.5.15.3
...
/usr/lib64/libkworkspace5.so.5.15.3
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.15.3
/usr/lib64/libtaskmanager.so.5.15.3
