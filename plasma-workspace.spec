...
Source0  : https://github.com/KDE/plasma-workspace/archive/v5.16.4/plasma-workspace-5.16.4.tar.gz
...
%prep
%setup -q -n plasma-workspace-5.16.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564515744
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libcolorcorrect.so.5.16.4
...
/usr/lib64/libkworkspace5.so.5.16.4
/usr/lib64/libnotificationmanager.so.1
/usr/lib64/libnotificationmanager.so.5.16.4
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.16.4
/usr/lib64/libtaskmanager.so.5.16.4
