...
Requires: plasma-workspace-bin
Requires: plasma-workspace-data
Provides: plasma-workspace-devel
...
%prep
%setup -q -n plasma-workspace-5.13.4
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1535815509
mkdir clr-build
pushd clr-build
...
/usr/lib64/libexec/ksmserver-switchuser-greeter
...
%doc /usr/share/doc/plasma\-workspace/*
...
/usr/lib64/libcolorcorrect.so.5.13.4
/usr/lib64/libkworkspace5.so.5
/usr/lib64/libkworkspace5.so.5.13.4
/usr/lib64/libplasma-geolocation-interface.so.5
/usr/lib64/libplasma-geolocation-interface.so.5.13.4
/usr/lib64/libtaskmanager.so.5.13.4
